...
import 'package:church_platform/views/old/sermon/SermonInfoWidget.dart';
...
class SermonMainWidget extends StatefulWidget {

  SermonMainWidget({Key key}) : super(key: key);

  @override
  _SermonMainWidgetState createState() => _SermonMainWidgetState();
}

class _SermonMainWidgetState extends State<SermonMainWidget> {
...
//                              softWrap: true,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SermonInfoWidget(showTitle:"敬拜",vedioUrlStr: snapshot.data.worshipvideo,)),
                      );
                    },
...
//                    color: Colors.grey,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SermonInfoWidget(showTitle:"主持",vedioUrlStr: snapshot.data.mcvideo, )),
                      );
                    },
                    child: CachedNetworkImage(
                      imageUrl: snapshot.data.cover,
...
//                    color: Colors.grey,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                         context,
                          MaterialPageRoute(builder: (context) => SermonInfoWidget(showTitle:"讲道",vedioUrlStr: snapshot.data.sermonvideo, pdfUrlStr: snapshot.data.pdf,)),
                      );
                    },
                    child: CachedNetworkImage(
                      imageUrl: snapshot.data.cover,
...
//                    color: Colors.grey,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SermonInfoWidget(showTitle:"奉献",vedioUrlStr: snapshot.data.givingvideo, )),
                      );
                    },
                    child: CachedNetworkImage(
                      imageUrl: snapshot.data.cover,
